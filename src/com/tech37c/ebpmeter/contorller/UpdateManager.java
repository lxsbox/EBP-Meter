...
import com.tech37c.ebpmeter.utils.ParseXmlUtil;
...
public class UpdateManager
{
	...
	private boolean isUpdate()
	{
		...
		InputStream inStream = ParseXmlUtil.class.getClassLoader().getResourceAsStream("version.xml");
...
//		String currVersion = sharedPreferences.getString(BackgroundService.APP_VERSION, "2");
		String currVersion = "2";
		if (null != currVersion)
		{
//			int serviceCode = Integer.valueOf(mHashMap.get("version"));
			// 版本判断
			if (Integer.parseInt(currVersion) > versionCode)
			{
				return true;
			}
		}
